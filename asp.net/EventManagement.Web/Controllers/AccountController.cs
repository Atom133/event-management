...
namespace EventManagement.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var user = new EventManagement.Domain.Entities.user { UserName = model.Email, Email = model.Email };
            //if ((user.IsValid == true) && (user.IsBlocked == false))
            //{
            switch (result)
            {
            ...
            //}
            //else ModelState.AddModelError("", "Compte Non Valide ");
            //return RedirectToAction("login", "Account"); //View(model);
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new EventManagement.Domain.Entities.user { UserName = model.Email, Email = model.Email,  DTYPE = model.DTYPE, cin = model.cin };
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new Domain.Entities.user { UserName = model.Email, Email = model.Email };
